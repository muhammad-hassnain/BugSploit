...
async function start(readyCallback) {
    ...
    await datacreator();
    datacreatorEnd();
    const port = (_a = process.env.PORT) !== null && _a !== void 0 ? _a : config_1.default.get('server.port');
    process.env.BASE_PATH = (_b = process.env.BASE_PATH) !== null && _b !== void 0 ? _b : config_1.default.get('server.basePath');
