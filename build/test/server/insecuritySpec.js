...
describe('insecurity', () => {
    ...
    describe('generateCoupon', () => {
        it('returns base85-encoded month, year and discount as coupon code', () => {
            ...
            expect(z85_1.default.decode(coupon).toString()).to.equal('JAN80-20');
        });
    ...
    describe('discountFromCoupon', () => {
        ...
        it('returns undefined for coupon code not according to expected pattern', () => {
            expect(security.discountFromCoupon(z85_1.default.encode('Test'))).to.equal(undefined);
            expect(security.discountFromCoupon(z85_1.default.encode('XXX00-10'))).to.equal(undefined);
            expect(security.discountFromCoupon(z85_1.default.encode('DEC18-999'))).to.equal(undefined);
            expect(security.discountFromCoupon(z85_1.default.encode('DEC18-1'))).to.equal(undefined);
            expect(security.discountFromCoupon(z85_1.default.encode('DEC2018-10'))).to.equal(undefined);
        });
        it('returns undefined for expired coupon code', () => {
            expect(security.discountFromCoupon(z85_1.default.encode('SEP14-50'))).to.equal(undefined);
        });
...
//# sourceMappingURL=insecuritySpec.js.map