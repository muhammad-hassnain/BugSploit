...
exports.publicKey = fs_1.default ? fs_1.default.readFileSync('encryptionkeys/jwt.pub', 'utf8') : 'placeholder-public-key';
...
const hash = (data) => crypto_1.default.createHash('md5').update(data).digest('hex');
exports.hash = hash;
const hmac = (data) => crypto_1.default.createHmac('sha256', 'pa4qacea4VK9t9nGv7yZtwmj').update(data).digest('hex');
exports.hmac = hmac;
...
const isDeluxe = (req) => {
    var _a, _b, _c, _d;
    const decodedToken = (0, exports.verify)(utils.jwtFrom(req)) && (0, exports.decode)(utils.jwtFrom(req));
    return ((_a = decodedToken === null || decodedToken === void 0 ? void 0 : decodedToken.data) === null || _a === void 0 ? void 0 : _a.role) === exports.roles.deluxe && ((_b = decodedToken === null || decodedToken === void 0 ? void 0 : decodedToken.data) === null || _b === void 0 ? void 0 : _b.deluxeToken) && ((_c = decodedToken === null || decodedToken === void 0 ? void 0 : decodedToken.data) === null || _c === void 0 ? void 0 : _c.deluxeToken) === (0, exports.deluxeToken)((_d = decodedToken === null || decodedToken === void 0 ? void 0 : decodedToken.data) === null || _d === void 0 ? void 0 : _d.email);
};
