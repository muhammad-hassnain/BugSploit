...
exports.SNIPPET_PATHS = Object.freeze(['./server.ts', './routes', './lib', './data', './frontend/src/app', './models']);
const findFilesWithCodeChallenges = async (paths) => {
    ...
    for (const currPath of paths) {
        if ((await promises_1.default.lstat(currPath)).isDirectory()) {
            ...
            const moreMatches = await (0, exports.findFilesWithCodeChallenges)(files.map(file => path_1.default.resolve(currPath, file)));
...
function getCodeChallengesFromFile(file) {
    ...
    const challenges = [...fileContent.matchAll(challengeKeyRegex)]
        .flatMap(match => { var _a, _b, _c; return (_c = (_b = (_a = match.groups) === null || _a === void 0 ? void 0 : _a.challenges) === null || _b === void 0 ? void 0 : _b.split(' ')) !== null && _c !== void 0 ? _c : []; })
        .filter(Boolean);
